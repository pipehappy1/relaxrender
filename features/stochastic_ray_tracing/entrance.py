...
def initScene():
    ...
    spheres[4].setSelf(md.Sphere(12, md.Vector3(92, 35, 65), md.Material(md.REFR, md.ZERO_VECTOR3, md.Vector3(0.5, 0.5, 1.), 4)))
    spheres[5].setSelf(md.Sphere(18, md.Vector3(8, 25, 80), md.Material(md.REFR, md.ZERO_VECTOR3, md.Vector3(1., 0.5, 0.5), 2)))
